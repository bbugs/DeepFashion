...
n_regions = 4
n_img_per_folder = 1000 / n_regions  # 250 for 4 regions per image.  1000 is number of files per folder
...
for item in data['items']:
    ...
    folder_id = img_id / n_img_per_folder  # img_id / 250 when n_regions=4
